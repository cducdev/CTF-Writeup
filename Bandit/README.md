...
Each level has its own `README.md`. Screenshots and other supporting files are stored in its `assets` directory. Use [TEMPLATE.md](./TEMPLATE.md) when adding a new writeup.
